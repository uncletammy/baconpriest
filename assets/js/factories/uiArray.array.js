var theModule = angular.module('baconpriest');

// Adds a shortcut method for building uiArray factories
theModule.uiArray = function (factoryId, definition, primaryKey) {
  ...
  '$rootScope',
  '$q',
  function ($injector, $timeout, $rootScope, $q){
    ...
    soonToBePrototype.extend = function (items){
      ...
      _.each(_.compact(self), function (existingItem,index){
